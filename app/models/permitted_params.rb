class PermittedParams < Struct.new(:params)
  ...
  def user_attributes
    [:name, :avatar_kind, :email, :password, :password_confirmation, :current_password,
     ...
     :legal_accepted, :discussion_stages, :discussion_breakouts, {email_new_discussions_and_proposals_group_ids: []}]
  end
  ...
  def discussion_attributes
    [:title, :description, :num_stages, :has_all, :has_random, :has_long, :group_id, :private,
  ...
  def comment_attributes
    [:body, :discussion_id, :parent_id, :breakout_id, :document_ids, {document_ids: []}]
  end
